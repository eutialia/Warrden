...
export function DebugFrame() {
  ...
  return (
    <>
      ...
      <div className="pointer-events-none select-none fixed bottom-2 left-1/2 z-50 -translate-x-1/2 rounded-md bg-amber-500 px-3 py-1 text-xs font-medium text-black shadow">
